...
The statistical uncertainty $\sigma_{i,\text{stat}}$ is assumed to scale with the square root of expected number of events. Correcting for bias from systematic shifts, the statistical uncertainty is equal to
\begin{equation}
