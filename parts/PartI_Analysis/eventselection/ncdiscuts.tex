...
The Gaussian-like primary vertex distribution (Figure~\ref{fig:cp_lepto}\subref{fig:cplep_subfig1},~\ref{fig:cp_ariadne}\subref{fig:cpari_subfig1}) reflects charge the bunch 
