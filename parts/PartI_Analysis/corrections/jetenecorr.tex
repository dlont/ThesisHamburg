...
\end{itemize}
In general, the two approaches are equivalent if the unfolding of the measured cross sections is performed\marginpar{OB:Why?\\DL:because the correctly constructed response matrix has to take the migrations due to energy loss into account}. In this thesis, the top-down approach was adopted.
...
\begin{figure}[p]
\centering
\includegraphics[width=\linewidth]{./Figures/etcorr/new/coeff/05e_lepto_coeffitients}
