...
\begin{figure}[ht!]
\begin{center}
\begin{subfloat}[]{\includegraphics[width=.3\textwidth,trim={75 0 10 0},clip,angle=-90] {./Figures/tvrew/tvrew_lep07p_yda_ltv}
   \label{fig:tveffdatamc_subfig1}
 }%
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.4\textwidth,trim={75 0 10 0},clip,angle=-90]{./Figures/tvrew/tvrew_ari07p_yda_ltv}
   \label{fig:tveffdatamc_subfig2}
 }%
\end{subfloat}
\newline
\begin{subfloat}[]{\includegraphics[width=.4\textwidth,trim={75 0 10 0},clip,angle=-90] {./Figures/tvrew/ratio_tvrew_lep07p_yda_ltv}
   \label{fig:tveffdatamc_subfig3}
 }%
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.4\textwidth,trim={75 0 10 0},clip,angle=-90]{./Figures/tvrew/ratio_tvrew_ari07p_yda_ltv}
...
\begin{figure}[ht!]
\begin{center}
\begin{subfloat}[]{\includegraphics[width=.3\linewidth,trim={70 0 0 0},clip,angle=-90] {./Figures/tvrew/checktvrew_lep07p_yda_ltv}
   \label{fig:aftveffdatamc_subfig1}
 }%
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.3\linewidth,trim={70 0 0 0},clip,angle=-90]{./Figures/tvrew/checktvrew_lep07p_yda_sltv}
   \label{fig:aftveffdatamc_subfig2}
 }%
\end{subfloat}
\newline
\begin{subfloat}[]{\includegraphics[width=.3\linewidth,trim={70 0 0 0},clip,angle=-90] {./Figures/tvrew/checktvrew_ari07p_yda_ltv}
   \label{fig:aftveffdatamc_subfig3}
 }%
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.3\linewidth,trim={70 0 0 0},clip,angle=-90]{./Figures/tvrew/checktvrew_ari07p_yda_sltv}
