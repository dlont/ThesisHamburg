...
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.32\textwidth]{./Figures/bg/h_Yda_bgr_contro_plot_cs_lepto}
...
\end{subfloat}
\newline
 \begin{subfloat}[]{\includegraphics[width=.32\textwidth]{./Figures/bg/h_calet_bgr_contro_plot_cs_lepto}
   \label{fig:cpbg_subfig4}
 }%
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.32\textwidth]{./Figures/bg/h_siene_bgr_contro_plot_cs_lepto}
   \label{fig:cpbg_subfig5}
 }%
\end{subfloat}
 \begin{subfloat}[]{\includegraphics[width=.32\textwidth]{./Figures/bg/h_sith_bgr_contro_plot_cs_lepto}
