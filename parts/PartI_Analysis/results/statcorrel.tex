...
The estimate of covariance between numbers of jets in bins $i$ and $j$ can also be derived~\ref{upub:juanstatcorrel}:
\begin{equation}
...
The resulting correlation values for different bins of \dsdetjetb cross section in different regions of \qsq are presented in Figure~\ref{fig:correlmatrix} and in Table~\ref{}
\begin{figure}
	\centering
		\includegraphics[width=0.8\textwidth,angle=-90]{Figures/stat_correl/inclusive_correl}
